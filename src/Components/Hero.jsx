            ...
            <section>
                <div className="grid h-screen px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="mr-auto place-self-center lg:col-span-7">
                        ...
                        <FlipCounter/>
                        <a href="#" className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-red-400 border border-red-400 rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 ">
                            Get started
                        ...
                        <a href="#" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-red-400 border border-red-400 rounded-lg hover:bg-gray-600 focus:ring-4 focus:ring-gray-100">
                            Speak to Sales
                        </a>
                    </div>
